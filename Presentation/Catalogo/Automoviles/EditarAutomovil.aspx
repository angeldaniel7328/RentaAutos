<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarAutomovil.aspx.cs" Inherits="Presentation.Catalogo.Automoviles.EditarAutomovil" %>
    ...
    <div class="container">
        ...
        <div class="row form-group">
            ...
            <div style="position: absolute; top: 0; left: 0">
                <asp:RequiredFieldValidator ID="rfvtxtMatricula" ValidationGroup="Guardar" runat="server" CssClass="text-danger" ControlToValidate="txtMatricula" ErrorMessage="Matrícula del auto requerida"></asp:RequiredFieldValidator>
            </div>
            <div style="position: absolute; top: 0; left: 0">
        ...
        <div class="row form-group">
            ...
            <asp:RequiredFieldValidator ID="rfvtxtMarca" ValidationGroup="Guardar" runat="server" CssClass="text-danger" ControlToValidate="txtMarca" ErrorMessage="Marca del auto requerido"></asp:RequiredFieldValidator>
        </div>
        ...
        <div class="row form-group">
            ...
            <asp:RequiredFieldValidator ID="rfvtxtModelo" ValidationGroup="Guardar" runat="server" CssClass="text-danger" ControlToValidate="txtModelo" ErrorMessage="Modelo del auto requerido"></asp:RequiredFieldValidator>
        </div>
        ...
        <div class="row form-group">
            <div class="col-md-3" style="text-align: center;">
                ...
                <asp:Image ID="imgFotoAutomovil" Width="200" Height="200" runat="server" />
        ...
        <div class="row form-group">
            ...
            <div class="col-md-2">
                <asp:Button ID="btnEliminar" ValidationGroup="Eliminar" runat="server" Text="Eliminar" CssClass="btn btn-danger" OnClick="btnEliminar_Click" />
            </div>
        </div>
    </div>
</asp:Content>