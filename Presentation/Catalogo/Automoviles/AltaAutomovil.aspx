...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        ...
        <div class="row form-group">
            ...
            <div style="position:absolute;top:0;left:0;">
                <asp:RequiredFieldValidator ID="rfvTxtMatricula" ValidationGroup="Guardar" runat="server" CssClass="text-danger" 
                    ControlToValidate="txtMatricula" ErrorMessage="Matricula del auto requerida">
        ...
        <div class="row form-group">
            ...
            <div style="position:absolute;top:0;left:0;">
                <asp:RequiredFieldValidator ID="rfvTxtMarca" 
                    ValidationGroup="Guardar" runat="server" CssClass="text-danger" 
                    ControlToValidate="txtMarca" ErrorMessage="Marca del auto requerido">
                </asp:RequiredFieldValidator>
            </div>
        </div>
        ...
        <div class="row form-group">
            ...
            <div style="position:absolute;top:0;left:0;">
                <asp:RequiredFieldValidator ID="rfvTxtModelo" 
                    ValidationGroup="Guardar" runat="server" CssClass="text-danger" 
                    ControlToValidate="txtModelo" ErrorMessage="Modelo del auto requerido">
                </asp:RequiredFieldValidator>
            </div>
        </div>
