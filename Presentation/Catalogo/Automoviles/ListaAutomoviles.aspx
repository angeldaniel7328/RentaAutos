        ...
        <div class ="row col-md-10 col-md-offset-1">
            <asp:GridView ID="gvAutomoviles" runat="server" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Id" ItemStyle-Width="50px" DataField="IdAutomovil" ReadOnly="true" />
                    <asp:BoundField HeaderText="Marca" ItemStyle-Width="150px" DataField="Marca" />
                    <asp:BoundField HeaderText="Modelo" ItemStyle-Width="80px" DataField="Modelo" />
                    <asp:BoundField HeaderText="Matricula" ItemStyle-Width="80px" DataField="Matricula" />
