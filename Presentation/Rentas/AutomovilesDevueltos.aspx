<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AutomovilesDevueltos.aspx.cs" Inherits="Presentation.Rentas.AutomovilesDevueltos" %>
        ...
        <div class="row col-md-10 col-md-offset-1">
            <asp:GridView ID="gvRentas" runat="server" AutoGenerateColumns="false" DataKeyNames="IdRenta" OnRowCommand="gvRentas_RowCommand">
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Fecha y Hora" ItemStyle-Width="150px" DataField="FechaHora" />
